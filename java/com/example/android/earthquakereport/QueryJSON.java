...
public class QueryJSON {
    ...
    private static String JSONString
            ...
            "            \"time\":1453777820750,\n" +
            "            \"updated\":1466450055338,\n" +
            "            \"tz\":600,\n" +
            "            \"url\":\"http://earthquake.usgs.gov/earthquakes/eventpage/us20004uks\",\n" +
            "            \"detail\":\"http://earthquake.usgs.gov/fdsnws/event/1/query?eventid=us20004uks&format=geojson\",\n" +
            "            \"felt\":null,\n" +
            "            \"cdi\":null,\n" +
            "            \"mmi\":4.1,\n" +
            "            \"alert\":\"green\",\n" +
            ...
            "            \"time\":1453695722730,\n" +
            "            \"updated\":1466450270946,\n" +
            "            \"tz\":0,\n" +
            "            \"url\":\"http://earthquake.usgs.gov/earthquakes/eventpage/us10004gy9\",\n" +
            "            \"detail\":\"http://earthquake.usgs.gov/fdsnws/event/1/query?eventid=us10004gy9&format=geojson\",\n" +
            "            \"felt\":117,\n" +
            "            \"cdi\":7.2,\n" +
            "            \"mmi\":5.28,\n" +
            "            \"alert\":\"green\",\n" +
            ...
            "            \"net\":\"us\",\n" +
            "            \"code\":\"10004gy9\",\n" +
            "            \"ids\":\",gcmt20160125042203,us10004gy9,gcmt20160125042202,\",\n" +
            "            \"sources\":\",gcmt,us,gcmt,\",\n" +
            ...
            "            \"time\":1453631430230,\n" +
            "            \"updated\":1469293028539,\n" +
            "            \"tz\":-540,\n" +
            "            \"url\":\"http://earthquake.usgs.gov/earthquakes/eventpage/us10004gqp\",\n" +
            "            \"detail\":\"http://earthquake.usgs.gov/fdsnws/event/1/query?eventid=us10004gqp&format=geojson\",\n" +
            "            \"felt\":1816,\n" +
            "            \"cdi\":7.2,\n" +
            "            \"mmi\":6.6,\n" +
            "            \"alert\":\"green\",\n" +
            ...
            "            \"net\":\"us\",\n" +
            "            \"code\":\"10004gqp\",\n" +
            "            \"ids\":\",at00o1gd6r,us10004gqp,ak12496371,gcmt20160124103030,\",\n" +
            "            \"sources\":\",at,us,ak,gcmt,\",\n" +
            ...
            "            \"time\":1453399617650,\n" +
            "            \"updated\":1466450324948,\n" +
            "            \"tz\":-420,\n" +
            "            \"url\":\"http://earthquake.usgs.gov/earthquakes/eventpage/us10004g4l\",\n" +
            "            \"detail\":\"http://earthquake.usgs.gov/fdsnws/event/1/query?eventid=us10004g4l&format=geojson\",\n" +
            "            \"felt\":11,\n" +
            "            \"cdi\":2.7,\n" +
            "            \"mmi\":3.92,\n" +
            "            \"alert\":\"green\",\n" +
            ...
            "            \"net\":\"us\",\n" +
            "            \"code\":\"10004ebx\",\n" +
            "            \"ids\":\",us10004ebx,gcmt20160114032534,pt16014050,at00o0xauk,gcmt20160114032533,\",\n" +
            "            \"sources\":\",us,gcmt,pt,at,gcmt,\",\n" +
            ...
            "            \"time\":1452741928270,\n" +
            "            \"updated\":1463165886000,\n" +
            "            \"tz\":-240,\n" +
            "            \"url\":\"http://earthquake.usgs.gov/earthquakes/eventpage/us10004ebw\",\n" +
            "            \"detail\":\"http://earthquake.usgs.gov/fdsnws/event/1/query?eventid=us10004ebw&format=geojson\",\n" +
            "            \"felt\":3,\n" +
            "            \"cdi\":2.2,\n" +
            "            \"mmi\":2.21,\n" +
            "            \"alert\":\"green\",\n" +
            ...
            "            \"time\":1452532083920,\n" +
            "            \"updated\":1463165873000,\n" +
            "            \"tz\":540,\n" +
            "            \"url\":\"http://earthquake.usgs.gov/earthquakes/eventpage/us10004djn\",\n" +
            "            \"detail\":\"http://earthquake.usgs.gov/fdsnws/event/1/query?eventid=us10004djn&format=geojson\",\n" +
            "            \"felt\":8,\n" +
            "            \"cdi\":3.4,\n" +
            "            \"mmi\":3.74,\n" +
            "            \"alert\":\"green\",\n" +
            ...
            "            \"time\":1452530285900,\n" +
            "            \"updated\":1466450384901,\n" +
            "            \"tz\":480,\n" +
            "            \"url\":\"http://earthquake.usgs.gov/earthquakes/eventpage/us10004dj5\",\n" +
            "            \"detail\":\"http://earthquake.usgs.gov/fdsnws/event/1/query?eventid=us10004dj5&format=geojson\",\n" +
            "            \"felt\":1,\n" +
            "            \"cdi\":2.7,\n" +
            "            \"mmi\":7.5,\n" +
            "            \"alert\":\"green\",\n" +
            ...
            "            \"net\":\"us\",\n" +
            "            \"code\":\"10004dj5\",\n" +
            "            \"ids\":\",gcmt20160111163807,at00o0srjp,pt16011050,us10004dj5,gcmt20160111163805,\",\n" +
            "            \"sources\":\",gcmt,at,pt,us,gcmt,\",\n" +
            "            \"types\":\",associate,cap,dyfi,geoserve,impact-link,impact-text,losspager,moment-tensor,nearby-cities,origin,phase-data,shakemap,tectonic-summary,\",\n" +
            "            \"nst\":null,\n" +
            "            \"dmin\":3.144,\n" +
            ...
            "            \"time\":1451986454620,\n" +
            "            \"updated\":1466450408406,\n" +
            "            \"tz\":-540,\n" +
            "            \"url\":\"http://earthquake.usgs.gov/earthquakes/eventpage/us10004bgk\",\n" +
            "            \"detail\":\"http://earthquake.usgs.gov/fdsnws/event/1/query?eventid=us10004bgk&format=geojson\",\n" +
            "            \"felt\":0,\n" +
            "            \"cdi\":1,\n" +
            "            \"mmi\":0,\n" +
            "            \"alert\":\"green\",\n" +
    ...
    public static ArrayList<ReportWord> getQuakeDetails(){
        ...
        ArrayList<ReportWord> words = new ArrayList<ReportWord>();
